...
from webdriver_manager.firefox import GeckoDriverManager  # Changed the import for Firefox
...
class FlickrScraper:
    def __init__(self, scraper_url: str, max_images: int | None = None) -> None:
        ...
        # Call the method to download GeckoDriver if needed (for Firefox)
    ...
    def download_geckodriver(self):
        try:
            ...
            self.logger.error(f"Failed to download GeckoDriver: {e}")
